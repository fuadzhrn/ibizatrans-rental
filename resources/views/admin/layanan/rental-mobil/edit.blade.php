...
@section('page_title', 'Edit Rental Mobil')

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Form Edit Rental Mobil</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.layanan.rental-mobil.update', $vehicle) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Seats</label>
                        <input type="number" name="seats" class="form-control" value="{{ old('seats', $vehicle->seats) }}" min="1" max="60">
                    </div>
                    <div class="form-group col-md-4">
